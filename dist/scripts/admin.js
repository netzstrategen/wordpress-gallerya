...
(function ($) {
        ...
        success: function (response) {
          ...
          if (response && true === response.success) {
            response.images.forEach(item => {
              $(`#variation_gallery_${response.variation_id} .variation_gallery__images`).append(`<li
  ...
  $('#woocommerce-product-data').on('woocommerce_variations_loaded', function () {
    ...
    $('.variation_gallery').on('click', '.variation_gallery__add-image', function () {
      ...
      $(`#variation_gallery_${variation_id} .variation_gallery__images`).append('<li class="variation_gallery__image variation_gallery__image--placeholder"></li>');
    ...
    $('.variation_gallery').on('click', '.variation_gallery__image', function () {
      const $this = $(this);
      if ($this.hasClass('variation_gallery__placeholder') || $this.hasClass('disabled')) {
        return;
      }
